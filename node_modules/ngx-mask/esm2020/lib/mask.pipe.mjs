...
MaskPipe.ɵfac = i0.ɵɵngDeclareFactory({ minVersion: "12.0.0", version: "13.3.8", ngImport: i0, type: MaskPipe, deps: [{ token: i1.MaskApplierService }], target: i0.ɵɵFactoryTarget.Pipe });
